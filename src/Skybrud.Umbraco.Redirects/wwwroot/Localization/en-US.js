export default {
	...
	redirectsProperties: {
		...
		originalUrl: "Original URL",
		originalUrlDescription: "Specify the original URL to match from which the user should be redirected to the destination. Please start the original URL with a / sign.",
		destination: "Destination",
